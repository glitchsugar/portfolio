...
function openQuad() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/ZkwCC8hXR', '_blank');
}

function openArcs() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/gVgRCaHIv', '_blank');
}

function openVert() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/IZ7O8KyqV', '_blank');
}

function openEll() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/dNA19S5EY', '_blank');
}

function openTor() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/RvLdUkhUh', '_blank');
}

function openSphe() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/fRrEMQydR', '_blank');
}