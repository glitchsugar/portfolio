...
function openCB() {
    window.open('cat-burger-site/index.html', '_blank');
}

function openCFL() {
    window.open('codingfromlife/index.html', '_blank');
}

function openDV() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/rNt9zrHxe', '_blank');
}

function openAV() {
    window.open('https://editor.p5js.org/glitchsugar/sketches/BdBC01AKjw', '_blank');
}